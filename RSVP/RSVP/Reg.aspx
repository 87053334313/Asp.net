...
<asp:Content ID="RegistrationContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div>
            <label>Ваш эмэйл:</label><asp:TextBox ID="email" runat="server"></asp:TextBox>
        ...
        <div>
        Введите аннотацию доклада:<asp:TextBox ID="TextBoxAnot" runat="server" Width="345px"></asp:TextBox>
        </div>
